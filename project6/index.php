...
<html>
    ...
    <body>
        ...
        <svg width="500" height="400">
            ...
            <rect id="d1" class="die" x="300" y="100" width="100" height="100" />
           ...
           <circle id="results-container" cx="250" cy="325" r="25" />
        
           <text id="point" x="250" y="334">X</text>
           
           <text id="message" x="203" y="380">Roll to Play</text>
