...
<html>
    ...
    <body>
        ...
        <p style="font-style:bold;">The following companies have been registered in the database.</p>
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>" .
             ...
             "<td><button onclick='deleteCompany(" . $row["COM_ID"] . ")'></button>  <button onclick='updateCompany(" . $row["COM_ID"] . ")'></button></td>" .
             "</tr>";
    }
} else {
...
?>
            ...
            <button onclick="location.href = 'create.php'"></button> 
    </body>
</html>
